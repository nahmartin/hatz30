...
class Car(models.Model):
    ...
    video_photo = models.TextField(
        default='https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/YouTube_full-color_icon_%282017%29.svg/1024px-YouTube_full-color_icon_%282017%29.svg.png')
    video_link = models.TextField(
        default='<iframe width="1029" height="579" src="https://www.youtube.com/embed/BcJN9JGaYFQ" title="1977 CHEVROLET K20" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>')
...
class CarPhoto(models.Model):
    ...
    photo1 = models.TextField(
        default='https://cdn.dealeraccelerate.com/worldwide/1/8226/510832/1920x1440/w/1986-mercedes-benz-560sl')
...
class CarPhotoSold(models.Model):
    car = models.ForeignKey(CarSold, on_delete=models.CASCADE)
    photo1 = models.TextField(
        default='https://cdn.dealeraccelerate.com/worldwide/1/8226/510832/1920x1440/w/1986-mercedes-benz-560sl')
